...
exports.RiftGate = () => {
    ...
    if (!component) {
        console.error(`RiftGate nested level: ${index} not will render component. Please check your routes`);
        return null;
    }
    return (react_1.default.createElement(react_1.default.Fragment, null, typeof component === 'function' ? component({ router }) : component));
};
