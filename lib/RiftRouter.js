...
var RiftRouter = /** @class */ (function () {
    ...
    RiftRouter.prototype.updateActiveRoute = function () {
        ...
        if (aux.length === 2 && aux[1]) {
            var _a = aux[1].split('#'), searchAux = _a[0], hash = _a[1];
            search = aux.length === 2 ? this.queryString("?" + searchAux) : {};
        }
        for (var _i = 0, _b = this.routes; _i < _b.length; _i++) {
            var route = _b[_i];
            var _c = this.checkMatch(route, path), match = _c.match, params = _c.params, pattern = _c.pattern;
    ...
    RiftRouter.prototype.setRoutes = function (routes, components, parent, hooks) {
        ...
        for (var _i = 0, routes_1 = routes; _i < routes_1.length; _i++) {
            ...
            var children = route.children, component = route.component, path = route.path, onEnter = route.onEnter, onLeave = route.onLeave;
            if (children) {
                aux = aux.concat(this.setRoutes(children, components.concat(component), parent + path, {
    ...
    RiftRouter.prototype.checkMatch = function (route, currentPath) {
        var _a = route.path, path = _a === void 0 ? '/' : _a;
        var match = false;
    ...
    __decorate([
        mobx_1.observable
    ], RiftRouter.prototype, "path", void 0);
    __decorate([
        mobx_1.observable
    ], RiftRouter.prototype, "params", void 0);
    __decorate([
        mobx_1.observable
    ], RiftRouter.prototype, "search", void 0);
    __decorate([
        mobx_1.observable
    ], RiftRouter.prototype, "active", void 0);
    __decorate([
        mobx_1.action
    ], RiftRouter.prototype, "riftTo", null);
    __decorate([
        mobx_1.action
    ], RiftRouter.prototype, "updateActiveRoute", null);
    return RiftRouter;
}());
